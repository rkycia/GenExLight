...
////////////////////////////////////////////////////////////////////////
TEventMaker2toN::TEventMaker2toN(double tecm, double p_min, double p_max, double y_min, double y_max, int nop, double mass_min, double mass_max, double* mass, int* idIn, int* idOut, TLorentzVector* pb, TLorentzVector* pf, int isol) 
{
...
////////////////////////////////////////////////////////////////////////
int TEventMaker2toN::CalculateKinematics(double p1t, double p2t, double dphi1, double dphi2, double y, double vmass2)
{
  TLorentzVector p1,p2,p3;
   ...
   // a p1z^2 + b p1z + c = 0
	...
	else if( isol == 1 ) //bouncing solution
	{
		if( pp1z[0] * pb[1].Pz() < 0 )
			iselect = 0;
		else 
    ...
    p1.SetXYZT(pp1.X(), pp1.Y(), pp1z[iselect], pp10[iselect]); 
    p2.SetXYZT(pp2.X(), pp2.Y(), pp2z[iselect], pp20[iselect]);
...
double TEventMaker2toN::SetEvent( int nDim, double *Xarg )
{
   ...
   //intermediate mass
    ...
    r = CalculateKinematics(p1t, p2t, dphi1, dphi2, y, mass2);
