...
public:
	...
	TDensity(double tecm, double p_min, double p_max, double y_min, double y_max, int nop, double mass_min, double mass_max, double* mass, int* idIn, int* idOut, TLorentzVector* pb, TLorentzVector* pf, int isol);
...
TDensity::TDensity(double tecm, double p_min, double p_max, double y_min, double y_max, int nop, double mass_min, double mass_max, double* mass, int* idIn, int* idOut, TLorentzVector* pb, TLorentzVector* pf, int isol)
{ 
	
	_decay = new TEventMaker2toN( tecm, p_min, p_max, y_min, y_max, nop, mass_min, mass_max, mass, idIn, idOut, pb, pf, isol);
...
int main()
{
	...
	TDensity *rho = new TDensity(tecm, p_min, p_max, y_min, y_max, Nop, mass_min, mass_max, mass, idIn, idOut, pb, pf, isol);   //Create density
