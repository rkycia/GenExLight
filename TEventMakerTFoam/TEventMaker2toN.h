...
private:
	...
	int CalculateKinematics(double p1t, double p2t, double dphi1, double dphi2, double y, double vmass2);
...
public:
    ...
    ///Constructor
    /// @param tecm center of mass energy
    /// @param p_min minimal transverese momenta of leading particles
    /// @param p_max maximal transverese momenta of leading particles
    /// @param y_min minimal rapidity of the central blob
    /// @param y_max maximal rapidity of the central blob
    /// @param mass_min minimal mass of the central blob
    /// @param mass_max maximal mass of the central blob
    /// @param mass mass matrix of central particles; 0 index is unused
    /// @param idIn PDG codes of incoming particles
    /// @param idOut PDG codes of outgoing particles
    /// @param pb array of four momenta of incoming particles
    /// @param pf array of four momenta of outgoing particles
    /// @param isol selecting solution: 0 - nonbouncing; 1- bouncing
    TEventMaker2toN(double tecm, double p_min, double p_max, double y_min, double y_max, int nop, double mass_min, double mass_max, double* mass, int* idIn, int* idOut, TLorentzVector* pb, TLorentzVector* pf, int isol);                    
